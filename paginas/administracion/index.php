...
<!-- HTML -->
  ...
  <!-- HEAD -->
    <head>
      ...
      <title>Administracion | Paginas | Servicios disponibles</title>
        ...
        <div class="sidebar"> 
            <nav class="mt-4">
                ...
                role="menu" data-accordion="false">
                    ...
                    <!--///BOTON CREACION DE PAGINAS WEB-->
                    <!--BOTON CREACION DE BASES DE DATOS-->
                    <li class="nav-item">
                            <a href="<?php echo $URL;?>/" 
                            class="nav-link active" >
                            <p>
              ...
              <div class="content-header">
                <div class="container-fluid">
                  <div class="row mb-2">
                    <div class="col-sm-12">
                      <center>
                        <h1 class="m-0" style="color: black;">TU NEGOCIO EN OTRO NIVEL</h1>
                      </center>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-6 col-sm-12 wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h3>Sistema completo de Administracion</h3>
                        <p>Tu negocio en linea donde todo mundo te pueda visitar.
                        Mira quien visita tu pagina , cual es el producto mas vendido ,
                         lista de usuarios , todos los proovedores
                        </p>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-sm-12 wow fadeInRight animated" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInRight;">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p>muestra todos tus productos a el mundo</p>
                    </div>
                </div>

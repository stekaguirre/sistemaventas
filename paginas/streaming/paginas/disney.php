...
<?php
    ...
    include ("../../../layout/analystracking.php");
  ?>
<!-- ///INCLUDE -->
...
<!--        HEAD             -->
  ...
  <html lang="es">
  <head>
  <title>Disney | Streaming | <?php echo APP_NAME; ?></title>
  <meta charset="utf-8">
  <meta name="viewport" 
        content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
  <link href="<?php echo $URL;?>/layout/streaming/paginas/disney/styles/layout.css" 
        rel="stylesheet" type="text/css" media="all">
  <link href="<?php echo $URL;?>/layout/streaming/paginas/disney/styles/styles.css" 
        rel="stylesheet" type="text/css" media="all">
  ...
  <!--       HEADER ARRIBA IZQUIERDO  DERECHO // ABAJO IZQUIERDO  DERECHO HEADER // TITULO DE PAGINA Y LOGO             -->
   ...
   <div class="row">
          <div style="background-color: white;">
            <center>
              <h3 style="color: blue;">Streaming - Disney</h3>
          ...
          <div class="sidebar one_quarter first"> 
            ...
            <!-- PRODUCTO MAS VENDIDO  -->
              <div class="sdb_holder">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="color: blue;">Producto mas vendido</h4>
                    <p class="card-subtitle "><h2>Netflix * 3 meses</h2></p>
                    <img src="<?php echo $URL;?>/public/images/streaming/fotodisney.jpg" class="card-img-top" alt="...">
            ...
            <!-- PRODUCTO MAS VENDIDO  -->
            <!-- OTRAS PLATAFORMAS  -->
              <h6 style="color:blue;">Otras Plataformas</h6>
              <nav class="sdb_holder">
                <ul>
